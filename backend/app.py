...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('SQLALCHEMY_DATABASE_URI', 'postgresql://learning_managemaent_system_user:RAlOrhYpIZQSIZLsm5btI5ZP9dVZR1xA@dpg-cueejjtds78s73ad3sj0-a.oregon-postgres.render.com/learning_managemaent_system')
